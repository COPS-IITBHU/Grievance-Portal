...
function page() {
    ...
    const onSubmit = async (data: any) => {
        ...
        //   await UserData.create(formData);    //TODO: Create a new model for UserData
          reset();
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    {watch("year") === "other" && (
                        <input
                            ...
                            {...register("customYear", { required: " year is required" })}
                        />
                    )}
                    </div>
                </div>  
                <div>
                    ...
                    >
                        {watch("gender") !== "male" && watch("gender") !== "female" && (<option value="">Select Gender First</option>)}
                        {watch("gender") === "male" && (<option value="">Select Hostel</option>)}
                        {watch("gender") === "female" && (<option value="">Select Hostel</option>)}
                        {watch("gender") === "male" && maleHostels.map((hostel) => (
                            <option key={hostel} value={hostel}>{hostel}</option>
                        ))}
                        {watch("gender") === "female" && femaleHostels.map((hostel) => (
                            <option key={hostel} value={hostel}>{hostel}</option>
                        ))}
                    </select>
                </div>  
